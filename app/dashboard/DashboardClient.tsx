          ...
          {groups.map(({ group, role }) => (
            ...
            >
              <div className="flex-1 min-w-0">
                ...
                {role === "ADMIN" && <div className="text-xs text-accent">Admin</div>}
              </div>
              {group._count.jobShares > 0 && (
          ...
          <div className="group-tabs-mobile">
            {groups.map(({ group }) => (
              ...
              >
                ...
                {group._count.jobShares > 0 && (
                  <span className="mobile-badge">{group._count.jobShares}</span>
                )}
              </button>
            ))}
          ...
          {selectedGroup && (
            <div className="flex items-center justify-between mb-6">
              ...
              <div className="flex items-center gap-2">
                <Link href={`/dashboard/groups/${selectedGroup.group.slug}`}>
