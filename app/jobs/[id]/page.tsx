  ...
  return (
    <div className="app-frame">
      ...
      <div className="card mb-6">
        ...
        <p className="text-lg text-muted mb-4">{job.company}</p>
        ...
        <div className="flex flex-wrap items-center gap-x-4 gap-y-2 text-sm mb-4">
          ...
          {job.hoursPerWeek && (
            <>
              <span className="text-tertiary">•</span>
              <span>{job.hoursPerWeek}u/week</span>
            </>
          )}
          {job.months && (
            <>
              <span className="text-tertiary">•</span>
              <span>{job.months} maanden</span>
            </>
          )}
          {job.teamSize && (
            <>
      ...
      <div className="card text-center">
        <p className="text-muted mb-4">
          Wil je ook opdrachten plaatsen en beheren?
        </p>
        <Link href="/login">
