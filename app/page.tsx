                  ...
                  >
                    ...
                    <div className="flex gap-3 pt-4 mt-4 border-t border-gray-800/50">
                      <button
                        ...
                        className="flex-1 flex items-center justify-center gap-2 px-4 py-3.5 bg-emerald-600 hover:bg-emerald-500 text-white rounded-lg font-medium transition-all hover:scale-[1.02] shadow-lg"
                      >
                      ...
                      <button
                        ...
                        className="flex items-center justify-center gap-2 px-4 py-3.5 bg-gray-800 hover:bg-gray-700 text-gray-300 rounded-lg font-medium transition-all hover:scale-[1.02] shadow-lg"
                      >
